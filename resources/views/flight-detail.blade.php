                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 text-right">
                                            ...
                                            <div>
                                                ...
                                                @if (Auth::check())
                                                    @if($return_d != '')
                                                     <a href="{{url('flight-list-return')}}?to={{$from}}&from={{$to}}&departure_date={{$departure_date}}&airline={{$airline}}&id_flight_to={{$id_flight_to}}&return_date={{$return_date}}&flight_type={{$flight_type}}&fly_class={{$fly_class}}&person={{$person}}" class="btn btn-primary">Choose</a>
                                                    @else
